...
| File | Technique | Glibc-Version |Applicable CTF Challenges | Requirements |
|------|-----------|---------------|--------------------------|--------------|
| [first_fit.c](first_fit.c) | Demonstrating glibc malloc's first-fit behavior. | | |n/a|
| [calc_tcache_idx.c](calc_tcache_idx.c) | Demonstrating glibc's tcache index calculation. | | |n/a|
| [fastbin_dup.c](fastbin_dup.c) | Tricking malloc into returning an already-allocated heap pointer by abusing the fastbin freelist. | | |Double Free|
